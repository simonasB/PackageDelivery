...
namespace PackageDelivery.WebApplication.Controllers {
    ...
    public class VehicleModelsController : Controller {
        ...
        public VehicleModelsController(IGenericRepository<VehicleModel> vehicleModelRepository,
            ILogger<VehicleModelsController> logger, IGenericRepository<VehicleMake> vehicleMakeRepository) {
