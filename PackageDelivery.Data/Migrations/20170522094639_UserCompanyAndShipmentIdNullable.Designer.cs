...
namespace PackageDelivery.WebApplication.Data.Migrations
{
    ...
    [Migration("20170522094639_UserCompanyAndShipmentIdNullable")]
    partial class UserCompanyAndShipmentIdNullable
    {
            ...
            modelBuilder.Entity("PackageDelivery.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("PackageDelivery.Domain.Entities.Shipment", "Shipment")
                        .WithMany("Orders")
