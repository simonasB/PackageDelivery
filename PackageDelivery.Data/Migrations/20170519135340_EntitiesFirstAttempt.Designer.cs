...
namespace PackageDelivery.Data.Migrations
{
    ...
    [Migration("20170519135340_EntitiesFirstAttempt")]
    partial class EntitiesFirstAttempt
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PackageDelivery.Domain.Entities.Item", b =>
                {
                    b.HasOne("PackageDelivery.Domain.Entities.Order", "OrderId")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PackageDelivery.Domain.Entities.Order", b =>
                {
                    b.HasOne("PackageDelivery.Domain.Entities.Address", "Delivery")
                        .WithMany("DeliveryOrders")
                        .HasForeignKey("DeliveryAddressId");

                    b.HasOne("PackageDelivery.Domain.Entities.Address", "PickUp")
            ...
            modelBuilder.Entity("PackageDelivery.Domain.Entities.PickUpPoint", b =>
                {
                    ...
                    b.HasOne("PackageDelivery.Domain.Entities.Company")
