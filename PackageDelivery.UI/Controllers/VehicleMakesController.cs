...
namespace PackageDelivery.UI.Controllers
{
    ...
    public class VehicleMakesController : Controller
    {
        ...
        private const string ApiUri = "VehicleMakes";

        public VehicleMakesController(IApiService apiService)
        {
        ...
        {
            return View(await _apiService.GetMany<VehicleMakeDto>(ApiUri));
        }
